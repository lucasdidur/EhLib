...
import jgettext.catalog.parse.ExtendedCatalogParser;
import jgettext.catalog.parse.MessageStreamParser;
import jgettext.catalog.parse.ParseException;
import jgettext.catalog.parse.UnexpectedTokenException;
