...
public class TabList1_8R1 implements TabList
{
    ...
    public void sendCustomTabList(Player player, String headerText, String footerText)
    {
        ...
        IChatBaseComponent header = ChatSerializer.a("{\"text\":\"" + Message.colorize(headerText) + "\"}");
        IChatBaseComponent footer = ChatSerializer.a("{\"text\":\"" + Message.colorize(footerText) + "\"}");
