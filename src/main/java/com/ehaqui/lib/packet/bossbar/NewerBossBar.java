...
public class NewerBossBar
{
    ...
    public NewerBossBar create()
    {
        if (getBarFlag() == null)
        {
            BossBar bar = plugin.getServer().createBossBar(Message.colorize(text), getBarColor(), getBarStyle());
            setBossBar(bar);
        }
        else
        {
            BossBar bar = plugin.getServer().createBossBar(Message.colorize(text), getBarColor(), getBarStyle(), getBarFlag());
            setBossBar(bar);
        }
