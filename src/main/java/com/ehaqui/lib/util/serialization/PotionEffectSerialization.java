...
/**
 * A class to help with the serialization of PotionEffects. The serialization technique is similar to that of serializing enchantments. The process can be as explained as such: <br/>
 * <br/>
 *
 * <pre>
