 ...
 * TacoSerialization will create a folder in your server plugins directory (wherever that may be) called 'TacoSerialization'. Inside the folder will be a config.yml file.
 * Various values can be turned off to prevent some keys from being generated.
 *
 * @author KILL3RTACO
...
public class PlayerSerialization
{
    ...
    /**
     * Serialize a Player into a JSONObject. The player's EnderChest, inventory (including armor) and stats such as experience and potion effects will be saved unless
     * disabled.
     *
