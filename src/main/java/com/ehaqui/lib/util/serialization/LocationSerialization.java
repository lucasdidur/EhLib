...
public class LocationSerialization
{
    ...
    public static Location getLocationMeta(JSONObject json)
    {
        try
        {
            ...
            return new Location(w, json.getDouble("x"), json.getDouble("y"), json.getDouble("z"), Float.parseFloat(json.getDouble("yaw") + ""), Float.parseFloat(json.getDouble("pitch") + ""));
        } catch (JSONException e)
        {
            e.printStackTrace();
            return null;
