...
/**
 * A class to help with the serialization of LivingEntities. If the given LivingEntity is a Player, it is cast as such and redirected to PlayerSerialization. <br/>
 * <br/>
...
public class LivingEntitySerialization
{
    ...
    /**
     * Spawn a LivingEntity in a desired Location with the given stats. The given string will be constructed into a JSONObject to use a reference to the entities stats.
     *
     * @param location
