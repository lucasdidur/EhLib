...
/**
 * A {@link ButtonStatic} that closes the {@link com.ehaqui.lib.menu.menus.Menu}.
 */
public class ButtonClose extends ButtonStatic
{

    public ButtonClose()
    {
        super("&c&lFechar Menu", new ItemStack(Material.BARRIER));
    }
