package com.ehaqui.lib.reflection;
...
import com.ehaqui.lib.message.fanciful.ArrayWrapper;


/**
 * A class containing static utility methods and caches which are intended as reflective conveniences. Unless otherwise noted, upon failure methods will return {@code null}.
 */
public final class Reflection
{
    ...
    /**
     * Gets a {@link Class} object representing a type contained within the {@code org.bukkit.craftbukkit} versioned package. The class instances returned by this method are
     * cached, such that no lookup will be done twice (unless multiple threads are accessing this method simultaneously).
     * 
     * @param className
     *            The name of the class, excluding the package, within OBC. This name may contain a subpackage name, such as {@code inventory.CraftItemStack}.
    ...
    /**
     * Retrieves a {@link Field} instance declared by the specified class with the specified name. Java access modifiers are ignored during this retrieval. No guarantee is made as
     * to whether the field returned will be an instance or static field.
     * <p>
     ...
     * </p>
     * <p>
     * If a field is deemed suitable for return, {@link Field#setAccessible(boolean) setAccessible} will be invoked with an argument of {@code true} before it is returned. This
    ...
    /**
     * Contains loaded methods in a cache. The map maps [types to maps of [method names to maps of [parameter types to method instances]]].
     */
    ...
    /**
     * Retrieves a {@link Method} instance declared by the specified class with the specified name and argument types. Java access modifiers are ignored during this retrieval. No
     ...
     * </p>
     * <p>
     * If a method is deemed suitable for return, {@link Method#setAccessible(boolean) setAccessible} will be invoked with an argument of {@code true} before it is returned. This
     * ensures that callers do not have to check or worry about Java access modifiers when dealing with the returned instance.
     * </p>
     * <p>
     * This method does <em>not</em> search superclasses of the specified type for methods with the specified signature. Callers wishing this behavior should use
