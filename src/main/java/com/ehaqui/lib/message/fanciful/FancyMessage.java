package com.ehaqui.lib.message.fanciful;

import static com.ehaqui.lib.message.fanciful.TextualComponent.rawText;
...
import com.ehaqui.lib.reflection.Reflection;
...
/**
 * Represents a formattable message. Such messages can use elements such as colors, formatting codes, hover and click data, and other features provided by the vanilla Minecraft <a
 * href="http://minecraft.gamepedia.com/Tellraw#Raw_JSON_Text">JSON message formatter</a>. This class allows plugins to emulate the functionality of the vanilla Minecraft <a
 * href="http://minecraft.gamepedia.com/Commands#tellraw">tellraw command</a>.
 * <p>
 * This class follows the builder pattern, allowing for method chaining. It is set up such that invocations of property-setting methods will affect the current editing component,
 * and a call to {@link #then()} or {@link #then(Object)} will append a new editing component to the end of the message, optionally initializing it with text. Further
...
public class FancyMessage implements JsonRepresentedObject, Cloneable, Iterable<MessagePart>, ConfigurationSerializable
{
    ...
    /**
     * Set the behavior of the current editing component to instruct the client to replace the chat input box content with the specified string when the currently edited part of
     * the {@code FancyMessage} is clicked. The client will not immediately send the command to the server to be executed unless the client player submits the command/chat message,
     ...
     * {@code FancyMessage} is SHIFT-CLICKED. The client will not immediately send the command to the server to be executed unless the client player submits the command/chat
     ...
     * {@code FancyMessage} is clicked. The client <b>will</b> immediately send the command to the server to be executed when the editing component is clicked.
     * 
     * @param command The text to display in the chat bar of the client.
     * @return This builder instance.
     */
     ...
     * </p>
     * 
     * @param lines The lines of text which will be displayed to the client upon hovering. The iteration order of this object will be the order in which the lines of the tooltip
     *            are created.
     * @return This builder instance.
     */
     ...
     * @return This builder instance.
     *//*
        * ------------ public FancyMessage translationReplacements(final Iterable<? extends CharSequence> replacements){ for(CharSequence str : replacements){
        * latest().translationReplacements.add(new JsonString(str)); }
        * 
        * return this; }
        */
    ...
    /**
     * Terminate construction of the current editing component, and begin construction of a new message component. After a successful call to this method, all setter methods will
     * refer to a new message component, created as a result of the call to this method.
     * 
    ...
    /**
     * Serialize this fancy message, converting it into syntactically-valid JSON using a {@link JsonWriter}. This JSON should be compatible with vanilla formatter commands such as
     * {@code /tellraw}.
     * 
    ...
    /**
     * Sends this message to a listignore of player. The player will receive the fully-fledged formatted display of this message.
     * 
     * @param players The player listignore who will receive the message.
     */
    ...
    /**
     * Sends this message to a command sender. If the sender is a player, they will receive the fully-fledged formatted display of this message. Otherwise, they will receive a
     * version of this message with less formatting.
     * 
    ...
    /**
     * Convert this message to a human-readable string with limited formatting. This method is used to send this message to clients without JSON formatting support.
     * <p>
    ...
    /**
     * Deserializes a JSON-represented message from a mapping of key-value pairs. This is called by the Bukkit serialization API. It is not intended for direct public API
     * consumption.
     * 
    ...
    /**
     * Deserializes a fancy message from its JSON representation. This JSON representation is of the format of that returned by {@link #toJSONString()}, and is compatible with
     * vanilla inputs.
     * 
